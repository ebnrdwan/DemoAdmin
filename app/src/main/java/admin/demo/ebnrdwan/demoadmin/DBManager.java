...
import admin.demo.ebnrdwan.demoadmin.lib.BrowserHistory;
import admin.demo.ebnrdwan.demoadmin.lib.Call;
import admin.demo.ebnrdwan.demoadmin.lib.GPS;
import admin.demo.ebnrdwan.demoadmin.lib.MessageType;
import admin.demo.ebnrdwan.demoadmin.lib.SMS;
import admin.demo.ebnrdwan.demoadmin.modules.FilterModule;
import admin.demo.ebnrdwan.demoadmin.modules.location.LocationModule;
import admin.demo.ebnrdwan.demoadmin.variables.DBResult;
...
public class DBManager extends SQLiteOpenHelper {
	...
	public static final Uri BROWSER_URI = Uri.parse("content://browser/bookmarks");
	...
	private static final String[] PROJECTION_BROWSER = new String[]{
			"_id", // 0
			"url", // 1
			"visits", // 2
			"date", // 3
